(custom-set-variables
 ...
 '(custom-enabled-themes '(doom-tomorrow-night doom-rouge))
 '(custom-safe-themes
 ...
 '(package-selected-packages
   '(cmake-mode doom-themes flatland-theme flatui-theme
		gruber-darker-theme jupyter verilog-ts-mode vhdl-ext)))
...
(custom-set-variables
 ...
 '(inhibit-startup-screen t)
 '(package-selected-packages
   '(doom-themes flatland-theme flatui-theme gruber-darker-theme vhdl-ext)))
